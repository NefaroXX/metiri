...
> **Archived: This was the original plan (Phases 0–6, plane-detection-centric).
> Superseded by the Revised Plan in `docs/plan.md` (2026-09-01).
> Kept for reference until the revised plan reaches implementation.**
